...
int main()
{
	...
	while (true)
	{
		...
		PKT_S_TEST_WRITE::BuffVictimsList vic0 = pktWriter.ReserveBuffVictimsList(&buffList[0], 3);
		{
			vic0[0] = 1000;
			vic0[1] = 2000;
			vic0[2] = 3000;		
		...
		PKT_S_TEST_WRITE::BuffVictimsList vic2 = pktWriter.ReserveBuffVictimsList(&buffList[2], 2);
		{
			vic2[0] = 3000;
			vic2[1] = 5000;
		}
